...
const navigation = [
  // { name: "Admin Profile", href: "/admin/profile", current: false },
  { name: "About User", href: "/admin/userData", current: false },
  { name: "Order Summary", href: "/admin/order", current: false },
  // { name: "Body Measurement", href: "/order_summary", current: false },
];
...
export default function NavAdmin() {
  ...
  return (
    <Disclosure as="nav" className="bg-vallartaBlue">
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-[70px] items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                >
                  ...
                  <p className="text-base">Nurse Uniform</p>
                </a>
              </div>
